...
private:
    ...
    ControlPackage::FieldSide ladoCampo; ///< dado que indica o lado da equipe no campo
    ControlPackage::TeamColor corEquipe; ///< dado que indica qual a cor do time
...
public:
    ...
    void coletaDados(const DataPackage& pacoteEntrada);
    void coletaDados(const AI2DSimulatorPackage& pacoteEntrada);
    void coletaDadosVisao(const VisionPackage& pacoteVisao);
    void coletaDadosEstados(const SSL_Referee& pacoteEstados);
    void coletaDadosControle(const ControlPackage& pacoteControle);
    void coletaDadosBola(const BallPackage& pacoteBola);
    ...
    ControlPackage::TeamColor getCorEquipe();
    int getIdGoleiro();
    ...
    Bola* getBola();
    ControlPackage::FieldSide getLadoCampo();
